...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'fb3d68c529234c85bd9867206cd87100',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'c', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '前端开发', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://chenglong.ml', // 网站地址
  ...
  // 网站字体
  FONT_STYLE: process.env.NEXT_PUBLIC_FONT_STYLE || ['lxgw wenkai', 'sans-serif'], // ['font-serif','font-sans'] 两种可选，分别是衬线和无衬线: 参考 https://www.jianshu.com/p/55e410bd2115
